...
- **[OpenShift `oc` Cheat Sheet](https://turtini.github.io/assets/cli-cheat-sheets/openshift-oc.pdf)**  
  Common OpenShift CLI workflows for cluster and application operators.

- **[vi / vim Cheat Sheet](https://turtini.github.io/assets/cli-cheat-sheets/vi-vim.pdf)**  
  Survival-grade vi/vim commands for fast editing on remote systems.

- **[YAML Basics Cheat Sheet](https://turtini.github.io/assets/cli-cheat-sheets/yaml-basics.pdf)**  
  Clean, practical YAML patterns for Kubernetes and infrastructure configs.
